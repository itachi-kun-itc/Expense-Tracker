...
function renderCarryover() {
  ...
  input.value=carryoverForMonth();monthLabel.textContent=`${year}年${month}月の開始時点`;modeLabel.textContent=mode==="manual"?"手動設定":mode==="auto"?"自動更新":"未設定";modeLabel.className=`carryover-mode ${mode||"pending"}`;
