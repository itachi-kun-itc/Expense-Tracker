...
function openModal(item=null) {
  ...
  if(item){clearDateInputMonth(dateInput);document.querySelector(`input[name="type"][value="${item.type}"]`).checked=true;amountInput.value=item.amount;dateInput.value=item.date;memoInput.value=item.memo||"";}else{dateInput.value="";focusDateInputOnMonth(dateInput,state.month);}
